...
class Twig_Lexer
{
    ...
    public function tokenize(Twig_Source $source)
    {
        ...
        if (!empty($this->brackets)) {
            ...
            throw new Twig_Error_Syntax(sprintf('No ha cerrado "%s".', $expect), $lineno, $this->source);
        }
    ...
    private function lexExpression()
    {
        ...
        if (preg_match('/\s+/A', $this->code, $match, null, $this->cursor)) {
            ...
            if ($this->cursor >= $this->end) {
                throw new Twig_Error_Syntax(sprintf('No ha cerrado "%s".', $this->state === self::STATE_BLOCK ? 'block' : 'variable'), $this->currentVarBlockLine, $this->source);
            }
        }
        ...
        elseif (false !== strpos(self::PUNCTUATION, $this->code[$this->cursor])) {
            ...
            elseif (false !== strpos(')]}', $this->code[$this->cursor])) {
                if (empty($this->brackets)) {
                    throw new Twig_Error_Syntax(sprintf('Inesperado "%s".', $this->code[$this->cursor]), $this->lineno, $this->source);
                }
        ...
        // unlexable
            ...
            throw new Twig_Error_Syntax(sprintf('Caracter inesperado "%s".', $this->code[$this->cursor]), $this->lineno, $this->source);
        }
    }
    ...
    private function lexComment()
    {
        if (!preg_match($this->regexes['lex_comment'], $this->code, $match, PREG_OFFSET_CAPTURE, $this->cursor)) {
            throw new Twig_Error_Syntax('Comentario sin cerrar.', $this->lineno, $this->source);
        }
    ...
    private function lexString()
    {
        if (preg_match($this->regexes['interpolation_start'], $this->code, $match, null, $this->cursor)) {
            ...
            if ($this->code[$this->cursor] != '"') {
                throw new Twig_Error_Syntax(sprintf('No cerrado "%s".', $expect), $lineno, $this->source);
            }
