...
EOF;
    ...
    {
        return <<<'EOF'
            body { background-color: #F9F9F9; color: #041830; font: 14px/1.4 Helvetica, Arial, sans-serif; margin: 0; padding-bottom: 45px; }
            ...
            .exception-summary { background: #041830; border-bottom: #041830; border-top: 1px solid #041830; flex: 0 0 auto; margin-bottom: 30px; }

            .exception-message-wrapper { display: flex; align-items: center; min-height: 70px; }
            .exception-message { flex-grow: 1; padding: 30px 0; }
            .exception-message, .exception-message a { color: #cfe5f8; font-size: 21px; font-weight: 400; margin: 0; }
            ...
            .trace-head .trace-class { color: #041830; font-size: 18px; font-weight: bold; line-height: 1.3; margin: 0; position: relative; }

            .trace-message { font-size: 14px; font-weight: normal; margin: .5em 0 0; }

            .trace-file-path, .trace-file-path a { margin-top: 3px; color: #999; color: #795da3; color: #181818; color: #041830; font-size: 13px; }
            .trace-class { color: #181818; }
            .trace-type { padding: 0 2px; }
            .trace-method { color: #181818; color: #041830; font-weight: bold; color: #181818; }
            .trace-arguments { color: #041830; color: #999; font-weight: normal; color: #795da3; color: #777; padding-left: 2px; }
